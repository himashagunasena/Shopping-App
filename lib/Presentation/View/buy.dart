      ...
      return Scaffold(
          ...
          body: Column(
              ...
              children: [
                Column(children:[
                  Container(
                      margin: EdgeInsets.all(DefaultPadding), padding: EdgeInsets.only(top:DefaultPadding*2),
                  ...
                  Container(
                      ...
                      child:Text("Shipping Value"+"  Rs $shipping.00",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500),
                      ))
                ]),
                FlatButton(
                  minWidth: size.width,
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Payment( item: widget.item,)),
                    );
                  },
